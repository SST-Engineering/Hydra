...
include_once __DIR__."/_class/exception.class.php";
include_once __DIR__."/_class/locale.class.php";
include_once __DIR__."/_class/myPdf.class.php";
include_once __DIR__."/_class/parsingHtml.class.php";
include_once __DIR__."/_class/parsingCss.class.php";
include_once __DIR__."/_class/tcpdfConfig.php";
     ...
     * document creator
     */
    if (!defined('PDF_CREATOR')) define('PDF_CREATOR', 'HTML2PDF - TCPDF');

    /**
     * document author
     */
    if (!defined('PDF_AUTHOR')) define('PDF_AUTHOR', 'HTML2PDF - TCPDF');

    /**
     * header title
     */
    if (!defined('PDF_HEADER_TITLE')) define('PDF_HEADER_TITLE', null);

    /**
     * header description string
     */
    if (!defined('PDF_HEADER_STRING')) define('PDF_HEADER_STRING', null);

    /**
     * image logo
     */
    if (!defined('PDF_HEADER_LOGO')) define('PDF_HEADER_LOGO', null);

    /**
     * header logo image width [mm]
     */
    if (!defined('PDF_HEADER_LOGO_WIDTH')) define('PDF_HEADER_LOGO_WIDTH', null);
...
'.$content.'
		...
		protected function _tag_open_PG($param)
		{
			$this->_setNewPage();
			return true;
		}
