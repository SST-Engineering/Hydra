...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    */
	...
	public function reconnectCache() {
		$this->_cellCollection->unsetWorksheetCells();
		$this->_cellCollection = PHPExcel_CachedObjectStorageFactory::getInstance($this);
	}
   ...
   /**
    ...
    private static function _checkSheetTitle($pValue)
    {
        ...
        if (str_replace(self::$_invalidCharacters, '', $pValue) !== $pValue) {
            throw new PHPExcel_Exception("Invalid character found in sheet title {$pValue} end of title");
        }
    ...
    */
    ...
    public function getComment($pCellCoordinate = 'A1')
    {
        ...
        if (strpos($pCellCoordinate,':') !== false || strpos($pCellCoordinate,',') !== false) {
            ...
            throw new PHPExcel_Exception('Worksheet: Cell coordinate can not be zero-length string.');
        } else {
     ...
     * @return array
     */
	public function rangeToArray($pRange = 'A1', $nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false, $use_calc_old=false) {
        // Returnvalue
        $returnValue = array();
                    ...
                    if ($cell->getValue() !== null) {
                        if ($cell->getValue() instanceof PHPExcel_RichText) {
                            ...
                            if ($calculateFormulas) {
                                $returnValue[$rRef][$cRef] = $cell->getCalculatedValue(true, $use_calc_old);
                            } else {
     ...
     * @return array
     */
	public function toArray($nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false, $use_calc_old=false) {
        // Garbage collect...
        $this->garbageCollect();
		...
		return $this->rangeToArray(	'A1:'.$maxCol.$maxRow,
									$nullValue, $calculateFormulas, $formatData, $returnCellRef, $use_calc_old);
    }
