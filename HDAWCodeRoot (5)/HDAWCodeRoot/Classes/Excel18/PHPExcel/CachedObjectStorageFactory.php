...
class PHPExcel_CachedObjectStorageFactory
{
    ...
    private static $_storageMethodDefaultParameters = array(
        ...
        self::cache_to_phpTemp              => array( 'memoryCacheSize' => '10MB'
                                                    ),
	 ...
	 * self::cache_in_memory
     **/
    public static function initialize($method = self::cache_to_phpTemp, $arguments = array())
    {
