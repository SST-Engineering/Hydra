...
dtmlXMLLoaderObject.prototype.getXMLTopNode=function(tagName, oldObj){
	...
	dhtmlxError.throwError("LoadXML", "Incorrect XML in TopNode getting "+tagName, [
		(oldObj||this.xmlDoc),
		this.mainObject
	]);
...
if (!_isIE) alert(navigator.userAgent);
_isIE = true;
...
dtmlXMLLoaderObject.prototype.doXPath=function(xpathExp, docObj, namespace, result_type){
	...
	if (_isIE){ //IE
		...
		if (!docObj)
			dhtmlxError.throwError("LoadXML", "Incorrect XML in XPath and IE", [
				(docObj||this.xmlDoc),
				this.mainObject
			]);
		...
		if (!docObj)
			dhtmlxError.throwError("LoadXML", "Incorrect XML in XPath and Mozilla", [
				(docObj||this.xmlDoc),
				this.mainObject
			]);
