...
var popup_mouseposX;
var popup_mouseposY;
var popup_oldfunction_sel;
var popup_oldfunction_down;
...
// general drag
  var is_drag = e.srcElement.id;
  if (is_drag && is_drag.indexOf('_drag') != -1) {
     var drag_element = e.srcElement;
     var element      = drag_element.parentElement;
    // var exit_element = document.getElementById(element.id+"_exit");

     element.style.position = "absolute";
     element.style.display  = "block";
     drag_element['target']   = element.id;

   //  if (exit_element) exit_element.onclick     = popup_exit;

     popup_dragging = true;
     popup_target   = element.id
     popup_mouseX   = ie ? window.event.clientX : e.clientX;
     popup_mouseY   = ie ? window.event.clientY : e.clientY;

 // if (ie)
       popup_oldfunction_sel = document.onselectstart;
       popup_oldfunction_down = document.onmousedown;
...
function popup_mouseup(e)
{
 ...
 // if (ie)
       document.onselectstart = popup_oldfunction_sel;
   document.onmousedown   = popup_oldfunction_down;
}
